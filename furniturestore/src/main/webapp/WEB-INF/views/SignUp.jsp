  ...
  <hr>
   ...
   <form class="form-horizontal" role="form">
    <div class="form-group">
      <label class="control-label col-xs-9 col-sm-2" for="email">First Name:</label>
      <div class="col-xs-9 col-sm-3">
        <input type="text" class="form-control" id="email" placeholder="Enter Name">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-xs-9 col-sm-2" for="email">Middle Name:</label>
      <div class="col-xs-9 col-sm-3">
        <input type="text" class="form-control" id="email" placeholder="Enter Name">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-xs-9 col-sm-2" for="email">Last Name:</label>
      <div class="col-xs-9 col-sm-3">
        <input type="text" class="form-control" id="email" placeholder="Enter Name">
      </div>
    </div>
